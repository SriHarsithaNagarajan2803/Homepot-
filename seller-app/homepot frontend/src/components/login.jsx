        ...
        <div className="max-w-xl w-full bg-white border border-orange-200 rounded-3xl p-8 shadow-xl mx-auto relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-5" autoComplete="off">
                ...
                {availableSpecialties.map((spec) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-4 py-2 rounded-full text-xs font-bold transition shadow-xs ${
                        isSelected 
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-stone-900 hover:bg-stone-800 text-white font-bold py-3.5 rounded-xl text-base transition shadow-md disabled:opacity-50 tracking-wider mt-4"
            >
